...
function createuser(){
    $.ajax({
        type: 'POST',
        url: 'hhtps://dev.stedi.me/user',
        data: JSON.stringify({userName: phonenumber, 'email': phonenumber, password: onetimepassword, 'verifyPassword': vpwd, 'accountType':'Personal'}),//we are using the email as the user name
